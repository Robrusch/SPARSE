...
This module focuses on cases where the threshold matrix is diagonal, $T=\mathrm{diag}(T_1,T_2,\dots,T_N)$,
all limits are well defined, and each threshold is either a finite number or $+\infty$.
