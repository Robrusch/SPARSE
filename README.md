...
There is only one independent dimension, typically chosen between [Length] in units of fm (femtometers) and [Energy] in units of MeV or GeV (Mega- or Giga- electron Volts).
...
The conversion between length-based and energy-based unis is easily achieved by means of the formula $\hbar c = 197.3 \text{MeV }\text{fm} = 1$.
